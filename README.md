...
## 🚀 Features & Overview
* **Compact Cyberpunk HUD Interface:** Real-time pinned top status header with live color palettes (Gold, Cyber Cyan, Matrix Green, and Danger Red), optimized for small phone screens without zooming out.
